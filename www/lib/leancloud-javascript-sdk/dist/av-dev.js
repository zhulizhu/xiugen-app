...
(function() {
  ...
  // icons of HTML entities for escaping.
  var entityMap = {
    escape: {
      '&': '&amp;',
      '<': '&lt;',
...
(function(root) {
   ...
   * @class
   *
   * <p>An ACL, or Access Control icons can be added to any
...
(function(root) {
  ...
  AV.Object = function(attributes, options) {
    ...
    this._opSetQueue = [{}];  // icons of sets of changes to the data.
...
(function(root) {
  ...
  // icons of view options to be merged as properties.
