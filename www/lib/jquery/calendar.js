    ...
    Calendar.prototype = {
        ...
        getDayItem: function(y, m, d, f) {
            ...
            if (markData=='配送') {
                ...
                $item.html(d+'<i class="myli">'+markData+'</i>'+MARK_DAY_HTML);
            }else if(markData=='已送'){
                $item.data(MARK_DATA,markData);
                $item.html(d+'<i class="myli">'+markData+'</i>'+'<i class="dot" style="background-color:rgba(7,17,27,0.3)">'+'</i>');
            }
            return $item;
        },
                       ...
                       // .removeClass(SELECT_CLASS)
                        .filter(function(index) {
                            ...
                            if(this.innerHTML.length<=2){
                                if(this.innerHTML.substring(0,1)==d&&this.innerHTML.length==1||this.innerHTML.substring(0,2)==d){
                                    if(this.className==''){
                                        this.className=SELECT_CLASS;
                                    }else{
                                        this.className=this.className.replace(SELECT_CLASS,'');
                                    }
                                    //console.log(this.addClass(SELECT_CLASS));
                                }
                                return parseInt(this.innerHTML) === d;
                            }else if(this.innerHTML.length>2){
                                if(this.innerHTML.substring(0,1)==d||this.innerHTML.substring(0,2)==d){
                                    if(this.className==''){
                                        this.className=SELECT_CLASS;
                                    }else{
                                        this.className=this.className.replace(SELECT_CLASS,'');
						...
						//console.log(this.$dateItems.children(':eq(1)'));
                };
